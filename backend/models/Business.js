...
const businessSchema = new mongoose.Schema(
  {
    ...
    config: {
      ...
      // 🔥 NEW: structured menu items (used for dynamic menu routing)
      menuItems: {
        type: [menuItemSchema],
        default: [],
      },
    ...
    i18n: {
      langButtons: {
        ar: {
          text: { type: String, default: "العربية" },
          payload: { type: String, default: "LANG_AR" },
        },
        en: {
          text: { type: String, default: "English" },
          payload: { type: String, default: "LANG_EN" },
        },
        he: {
          text: { type: String, default: "עברית" },
          payload: { type: String, default: "LANG_HE" },
        },
      },
    },
